...
"
" Tested and working on GVim >= 7.1 on Linux.
"
" CONFIGURATION - BROWSER
" CONFIGURATION - JAVA API PATH
"-----------------------------------------------------------------------------
let javadoc_path=g:javadoc_path
